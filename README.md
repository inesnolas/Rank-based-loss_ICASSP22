...
| ---               | ---           | ---	        |---			|---		    |---                 |
| **InitEmb**       | -0.23 (0.0)   |	0.31 (0.0)	|0.04 (0.0)	    |  0.7 k=1 | 0.93    |
| **QuadL**         | -0.17 (+0.06) | 0.31 (0.0)    |0.07 (+0.03)   |  0.35 k=20 |  0.8 |
| **RbL**			| -0.08 (+0.15) | 0.42 (+0.11)  |0.17 (+0.13)   | 0.46  k=17    | 0.85               |
| **RbL_unc**       | -0.22 (+0.01) |	0.22 (-0.09)|0.0 (+0.04)    |  0.31 k=35 |  0.63 |
| **RbL_RdmHierarchy**| -0.15 (+0.08) | -0.09 (-0.41)| -0.12 (-0.16)|   0.34 k=29 | 0.7   |
...
| **RbL**				| -0.08 (-0.04)| 0.46 (-0.19)| 0.19 (-0.12) | 0.61 k=37| 0.87 |
| **RbL_unc**|-0.16 (-0.12) |	0.38 (-0.27)	|0.11 (-0.2) |0.62 k=22 | 0.85 |
| **RbL_RdmHierarchy**|  | 	 |	| 0.7 k=14 | 0.84 |
...
|   		            | Sil Fine   | Sil Coarse    | avg Sil       | KNN acc Fine  | KNN acc Coarse|
| ---                   | ---        | ---	          |---			  |---		          |---                    |
| **InitEmb**           | 0.3 (0.0)  | 0.57 (0.0)    |0.43 (0.0)     |      0.91     k=4       |      1.0              |                    
| **QuadL**             | -0.19 (-0.5)	| 0.14 (-0.43) | -0.02	(-0.45) | 0.37   k=27             |   0.53                |                    
| **RbL**	            | 0.03 (-0.27) | 0.59 (+ 0.02) | 0.31 (-0.12) | 0.53   k=8           | 0.87                 |
| **RbL_unc**           |  0.14 (-0.15)	|	0.67 (+0.1)	 | 0.41 (-0.02)|   0.5 k=33| 0.93                       |                    
| **RbL_RdmHierarchy**  | -0.23 (-0.53) | -0.04 (-0.61)| -0.14 (-0.57)     |  0.27 k=7  | 0.53           |                    
